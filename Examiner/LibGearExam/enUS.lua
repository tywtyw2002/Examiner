...
LibGearExam.Patterns = {
	...
	--  Equip: Spell Power  --
	{ p = "Increases your spell penetration by (%d+)%.", s = "SPELLPENETRATION" },	-- Still exists on "Don Rodrigo's Band" (21563) -- Fixed in MoP or earlier

	{ p = "Increases spell power by (%d+)%.", s = "SPELLDMG" },
	{ p = "Increases spell power slightly%.", s = "SPELLDMG", v = 6 }, -- Bronze Band of Force
	...
	{ p = "%+(%d+) Shield Block Rating", s = "BLOCK" }, -- Combined Pattern: Covers [Shield Enchant] [Socket Bonus]
	...
	{ p = "%+(%d+) Crit$", s = { "CRIT", "SPELLCRIT" } },	-- Put on alert, and forced to match end of string as well as it was matching regular "+Critical Strike" line.
	...
	{ p = "(%d+) Critical strike%.", s = { "CRIT", "SPELLCRIT" } }, -- Kirin Tor head enchant, no "+" sign, lower case "s" and "r"
